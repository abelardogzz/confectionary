...
#DiModules structure
# ! <- opcional
#key[nombre, returnValue,!numeroDeParametros, lista de tipos de los parametros, cantidad de variables totales contando parametros, keys de las variables que eventualmente serán direcciones de memoria]
